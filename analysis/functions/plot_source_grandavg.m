function plot_source_grandavg(subject,save_path,mri,group_dir,group)
...
saveas(gcf,['sourceI_all_' group '.png']); drawnow;
...
set(gca,'FontSize',14);
print(['vis_gamma_1_all_' group],'-dpng','-r300');
view([-60 0]);
print(['vis_gamma_2_all_' group],'-dpng','-r300');
view([60 0]);
print(['vis_gamma_3_all_' group],'-dpng','-r300');
end